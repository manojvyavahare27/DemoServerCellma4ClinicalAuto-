...
test.describe('Excel Conversion', () => {
  test('Extract Patient Details', async ({ }) => {
    const excelFilePath =  process.env.EXCEL_FILE_PATH || "./ExcelFiles/ReferralDomain.xlsx";
    const jsonFilePath ="./TestDataWithJSON/ReferralDomain/ReferralDetails.json";
...
test.describe('New Patient', () => {
  test('Register New Patient', async ({ page }) => {
    ...
    for (const data of jsonData.addPatient) {
      ...
      //await loginpage.clickOnCellmaButton()
