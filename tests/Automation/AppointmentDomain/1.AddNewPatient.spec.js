  ...
  test('Register New Patient', async ({ page }) => {
    ...
    //  await expect(page.getByText("Middle name(s) is required")).toHaveText("Middle name(s) is required");
     ...
     // await addaddress.enterCountryonPopup(jsonData.permanentAddress[index].add_address6.toString());
      ...
      sqlFilePath = "SQLResults/AppointmentDomain/patientIData.json";
      ...
      sqlFilePath = "SQLResults/AppointmentDomain/patientAddressData.json";
      results = await executeQuery(sqlQuery, sqlFilePath);
      ...
      sqlFilePath = "SQLResults/AppointmentDomain/patientPIPData.json";
      results = await executeQuery(sqlQuery, sqlFilePath);
      ...
      sqlFilePath = "SQLResults/AppointmentDomain/patientPIPAddressData.json";
      results = await executeQuery(sqlQuery, sqlFilePath);
      // console.log("\n Address Details stored into the database: \n", results);
      // Option 1: Provide a second JSON file path
      // Provide both file path to the compareJsons.js file
      ...
      sqlFilePath = "SQLResults/AppointmentDomain/patientNewGPData.json";
      results = await executeQuery(sqlQuery, sqlFilePath);
      // console.log("\n Address Details stored into the database: \n", results);
      ...
      sqlFilePath = "SQLResults/AppointmentDomain/patientGPAddressData.json";
      results = await executeQuery(sqlQuery, sqlFilePath);
      // console.log("\n Address Details stored into the database: \n", results);
      // Option 1: Provide a second JSON file path
      // Provide both file path to the compareJsons.js file
