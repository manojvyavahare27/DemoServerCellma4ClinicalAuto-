class AddAddress
{
    constructor(page)
    {
        ...
        //this.dropdownCountry=page.locator("xpath=//input[@name='country']")
...
>>>>>>> e1a280a (Push all code)
        ...
        this.calender_StartDate=page.getByTestId('Start Date')
        this.calender_EndDate=page.getByTestId('End Date')
