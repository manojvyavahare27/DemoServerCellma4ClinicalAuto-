...
class ServiceBookApp
{
    ...
    constructor(page)
    {
        ...
        this.dropdownReasonforRescheduling=page.locator("xpath=//input[@name='rescheduled']")
        ...
        this.buttonProceedReschedulingConfirmation=page.locator("xpath=//button[@data-testid='Proceed']")
